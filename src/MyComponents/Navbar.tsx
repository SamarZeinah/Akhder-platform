...
const Navbar = () => {
  ...
  return (
    <header
      className={`fixed top-0 left-0 w-full z-50 py-5 transition-all duration-300 ${
        scrolled ? "bg-[#000000cc] backdrop-blur-sm" : "bg-transparent"
      }`}
    >
      <div className="max-w-7xl px-4 flex items-center justify-between h-16 mx-auto">
        {/* Logo */}
      ...
      {menuOpen && (
        <div className="absolute top-full right-4 bg-gray-900 text-white w-[85vw] max-w-[260px] px-4 py-4 rounded-lg shadow-lg z-50 md:hidden">
          <div className="space-y-3 text-center">
            <HashLink
              to="/#Home"
              className="block text-base hover:text-[#FFC107]"
