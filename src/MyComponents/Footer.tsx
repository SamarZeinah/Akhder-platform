...
const Footer = () => {
  return (
    <div id="contact" className="bg-[#006F3C] mt-16">
            ...
            <div>
              ...
              <ul className="space-y-6">
                <li>
                   ...
                   <HashLink smooth to="/#" className="text-xl hover:text-[#FFC107] underline">
                    Home
                    </HashLink>
                </li>
                <li>
                 
                   <HashLink smooth to="/#services" className="text-xl hover:text-[#FFC107] underline">
                    Services
                    </HashLink>
                </li>
                <li>
                
                   <HashLink smooth to="/#Contact" className="text-xl hover:text-[#FFC107] underline">
                    Contact us
                    </HashLink>
                </li>
                <li>
                 
                   <HashLink smooth to="/#about" className="text-xl hover:text-[#FFC107] underline">
                    About us
                    </HashLink>
                </li>
              </ul>
