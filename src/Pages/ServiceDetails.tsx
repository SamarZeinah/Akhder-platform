...
//   const { id } = useParams();
//   //  <h2 className="text-4xl font-bold">Service Details - ID: {id}</h2>
...
//       >
//         {/* content */}
//         <div className="relative z-20 flex flex-col items-center justify-between text-center md:text-start md:items-start px-8 pt-[150px] max-w-7xl mx-auto gap-10 pb-20">
...
//               We design modern, responsive websites that reflect your business
//               identity and showcase your services in the best possible way.
//               Whether you're looking for a profile website, an online store, or
//               a custom control panel, we're here to create the perfect solution.
//             </p>
//           </div>
//           <div>
...
//               <div className="text-white text-center w-full min-w-[120px] md:w-1/3 transform transition duration-300 hover:scale-x-110 rounded-xl">
...
//       </div>
//       {/* sec section */}
//       <div className="bg-[#006F3C] mt-16 py-16 px-4 text-center text-white">
//         <p className="font-bold text-[40px] md:text-[60px] leading-tight mb-6">
//           Creative & Tech-Driven Digital Solutions
//         </p>
//         <p className="font-light max-w-xl mx-auto text-lg">
//           We provide innovative web solutions that combine modern design with
//           effective performance to achieve your goals.
//         </p>
...
//               <div className="flex gap-5 mt-6 flex-wrap justify-center md:justify-start">
//                 <div className="flex gap-3 flex-wrap mt-4">
//                   {item.badges?.map((badge, i) => (
//                     <p
//                       key={i}
//                       className="font-bold bg-[#FFC107] text-white px-4 py-2 rounded-[16px] text-sm transition-transform duration-300 hover:scale-110 flex items-center"
//                     >
//                       {typeof badge === "string" ? (
//                         badge
//                       ) : (
...
//         {
//           title: "Mobile App 1",
//           desc: "Description for mobile app 1...",
//           image: photo1,
//           badges: [
//             { icon: <Star />, value: "10+" },
//             { icon: <Heart />, value: "50+" },
...
//         {
//           title: "Mobile App 2",
//           desc: "Description for mobile app 2...",
//           image: photo2,
//           badges: [
//             { icon: <Star />, value: "15+" },
//             { icon: <Heart />, value: "40+" },
...
//                   src={Insta}
//                   alt="Instagram"
//                   className="w-[40px] h-[40px] hover:scale-110 transition"
//                 />
//               </a>
//               <a href="#">
//                 <img
...
//         {selectedProjects.map((project, projIdx) => (
//           <div
//             key={`${id}-${projIdx}`}
//             className={`flex flex-col ${
//               projIdx % 2 === 0 ? "md:flex-row" : "md:flex-row-reverse"
//             } items-center justify-between text-white px-8 py-[16px] mt-[48px] gap-12 text-center md:text-start`}
//           >
//             <img
//               src={project.image}
...
>
        ...
        <div className="relative z-20 flex flex-col items-center justify-between text-center md:text-start md:items-start px-8 pt-[150px] max-w-7xl mx-auto gap-10 pb-20 opacity-0 translate-y-10 animate-fade-in-up">
          ...
          <div>
            ...
            <div className="flex gap-3 mt-7">
              {[Insta, Tiktok, Snap, Icon4].map((icon, i) => (
                <a key={i} href="#">
                  <img src={icon} alt={`icon-${i}`} className="w-[40px] h-[40px] hover:scale-110 transition" />
                </a>
              ))}
            </div>
